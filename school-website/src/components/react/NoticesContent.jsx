    ...
    <>
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
          <img src={(import.meta.env.BASE_URL + '/logo.svg').replace('//', '/')} alt="" className="w-[200px] sm:w-[300px] lg:w-[400px] opacity-[0.08] brightness-0 invert object-contain" aria-hidden="true" />
        </div>
